...
const projects = [
  {
    ...
    description:
      "A custom-built 6-degree-of-freedom robot arm with inverse kinematics, path planning, and camera-based control.",
    technologies: ["Python", "Onshape", "Placo", "OpenCV", "MediaPipe"],
    difficulty: 5,
    ...
    githubUrl: "#",
    images: [
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/rerun_view_of_robot_arm_with_movement_plots.png",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/fully_assembled_arm_holdin_pen.png",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/cad_model_of_arm.png",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/arm_moving_with_movement_plots_to_goal.mp4",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/fun_figure_8_demo.mp4",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/joint_space_path_planner.mp4",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/camera_base_pose_estimation.mp4",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/mediapipe_to_joint_position_live_tracking_demo.png",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/first_version_of_path_planner.mp4",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/map_of_possible_positions.png",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/almost_full_arm_assembly_without_roll_and_gripper.png",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/bottom_half_assembly.png",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/v1_pan_assembly.png",
      "https://pub-23ed2f7e90c646778e7f318e43b4e788.r2.dev/public/robot_project/bounding_box.png",
    ],
    imageDescriptions: [
      "Real-time visualization of the robot arm in Rerun showing joint positions, movement trajectories, and control plots during operation.",
      "Fully assembled 6-DOF robot arm holding a pen, demonstrating precision control and end-effector positioning.",
      "Complete CAD model of the robot arm designed in Onshape, showing all mechanical components and joint assemblies.",
      "Video demonstration of the arm moving to a target position with real-time movement plots and trajectory tracking.",
      "Fun demo showing the robot arm performing a smooth figure-8 motion pattern to test path planning algorithms.",
      "Joint-space path planner demonstration showing collision-free motion planning between different arm configurations.",
      "Camera-based pose estimation system tracking the robot arm's base position for spatial awareness.",
      "MediaPipe integration demo showing live hand tracking converted to joint positions for intuitive robot control.",
      "Early version of the path planning system testing different movement strategies and collision avoidance.",
      "3D visualization mapping all possible end-effector positions within the robot's workspace volume.",
      "Near-complete arm assembly showing the mechanical structure without the wrist roll joint and gripper attachment.",
      "Bottom half assembly detail showing the base, first joints, and structural components of the robot arm.",
      "First version pan assembly showing the initial rotating base mechanism design.",
      "Collision bounding box visualization for self-intersection detection during path planning operations.",
    ],
    details:
      "This is a current work-in-progress project exploring advanced robotics control. I designed the arm in Onshape and wrote all inverse kinematics from scratch instead of relying on black-box tooling. I've been using the Placo library and experimenting with different path-planning approaches including PRM, RRT, linear interpolation, and joint-space planning to find valid, non-self-intersecting motions. On top of that, I'm exploring different control ideas using cameras, depth cameras, and wrist-mounted IMUs to make arm control more intuitive and collect better data from human motion. I've learned a ton about robotic control through this project—especially the part where you finally plug it in and it immediately tomahawks across the desk, smashes your computer, and breaks something. That part's definitely my favorite.",
  },
  {
    id: 1,
